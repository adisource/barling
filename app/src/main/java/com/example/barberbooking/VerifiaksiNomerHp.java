...
public class VerifiaksiNomerHp extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verifiaksi_nomer_hp);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            User user = new User("Us","alamat",NoTelepon.getText().toString());
                            FirebaseFirestore db = FirebaseFirestore.getInstance();
                            db.collection("User").document(NoTelepon.getText().toString()).set(user);
                            startActivity(new Intent(VerifiaksiNomerHp.this, HomeActivity.class));
                            finish();
