...
public class BookingActivity extends AppCompatActivity {
        ...
        if (Common.step < 3 || Common.step == 0)
        {
            ...
            else if (Common.step == 2) //Pick time slot
            {
                if (Common.currentBarber != null)
                    loadTimesSlotOfBarber (Common.currentBarber.getBarberId());
    ...
    private void loadTimesSlotOfBarber(String barberId) {
        //send local Boradcast to fragment step 3
    ...
    private void loadBarberBySalon(String salonId) {
        ...
        // /AllSalon/Pancor/Branch/9Zee1nUS09d7r9zZGajG/Barbers
                    ...
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            ...
                            for (QueryDocumentSnapshot barberSnapshot:task.getResult())
                            {
                                ...
                                barber.setPassword(""); // Revove Password because in clien id
                                barber.setBarberId(barberSnapshot.getId()); //Get id of barber
                                barbers.add(barber);
                            }
                            //send broad to bookingsteep2Fragmen too Load recycler
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setOffscreenPageLimit(4); // We Have 4 Fragment
